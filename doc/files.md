...
* litefork.conf: contains configuration settings for liteforkd or litefork-qt
* liteforkd.pid: stores the process id of liteforkd while running
...
* debug.log: contains debug information and general logging generated by liteforkd or litefork-qt
