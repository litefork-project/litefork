...
"""Verify that starting litefork with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start litefork with -h for help text")
        ...
        self.log.info("Start litefork with -version for version information")
